...
let person = {
  ...
  appendTableRow4(table3b, document.getElementById("3A").children[0].children[0].children[1].children[0].innerHTML, document.getElementById("3A").children[0].children[0].children[1].children[1].innerHTML, document.getElementById("3A").children[0].children[0].children[1].children[2].innerHTML, document.getElementById("3A").children[0].children[0].children[1].children[1].innerHTML * document.getElementById("3A").children[0].children[0].children[1].children[2].innerHTML)
  appendTableRow4(table3b, document.getElementById("3A").children[0].children[0].children[2].children[0].innerHTML, document.getElementById("3A").children[0].children[0].children[2].children[1].innerHTML, document.getElementById("3A").children[0].children[0].children[2].children[2].innerHTML, document.getElementById("3A").children[0].children[0].children[2].children[1].innerHTML * document.getElementById("3A").children[0].children[0].children[2].children[2].innerHTML)
  appendTableRow4(table3b, document.getElementById("3A").children[0].children[0].children[3].children[0].innerHTML, document.getElementById("3A").children[0].children[0].children[3].children[1].innerHTML, document.getElementById("3A").children[0].children[0].children[3].children[2].innerHTML, document.getElementById("3A").children[0].children[0].children[3].children[1].innerHTML * document.getElementById("3A").children[0].children[0].children[3].children[2].innerHTML)
  appendTableRow4(table3b, "Total: ", "-", "-", (document.getElementById("3A").children[0].children[0].children[1].children[1].innerHTML * document.getElementById("3A").children[0].children[0].children[1].children[2].innerHTML) + (document.getElementById("3A").children[0].children[0].children[2].children[1].innerHTML * document.getElementById("3A").children[0].children[0].children[2].children[2].innerHTML) + (document.getElementById("3A").children[0].children[0].children[3].children[1].innerHTML * document.getElementById("3A").children[0].children[0].children[3].children[2].innerHTML))
